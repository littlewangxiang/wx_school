...
public class TimestampUtils {
    private static Log log = LogFactory.getLog(TimestampUtils.class);
    /**
     * 默认的日期格式
     */
    ...
    public static final String DATE_FORMAT_DDMM_HHMM = "dd/MM HH:mm";
    /**
     * 日期转换格式：MM-dd
     */
    ...
    public static String formatDate(Date date, int nFmt) {
        ...
        switch (nFmt) {
            ...
            case FMT_DATE_MMMDDD:
                ...
                break;
            case FMT_DATE_YYYYMMDDHHMM_NEW:
            ...
            case FMT_DATE_MMDD_HH_CH:
                ...
                break;
            case FMT_DATE_YYYYMMDD_HHSS:
                fmtDate.applyPattern("yyyy年MM月dd日HH时mm分");
                break;
            case FMT_DATE_MMDD_HHMMSS:
                fmtDate.applyPattern("MM-dd HH:mm:ss");
                break;
            case FMT_DATE_YYYYMMDD_DOT:
                fmtDate.applyPattern("yyyy.MM.dd");
                break;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(formatDate(getCurrentTimestamp(), FMT_DATE_SPECIAL));
    ...
    public static int getWeekth(Date d1, Date d2) {
        ...
        int diffdays = getDiffDays(t1, t2);
